...
output_prefix = 'dbfs:/mnt/gis20mock/gis20mock/illumnia_small'
numPartitions = 10
samples, total_reads = load_samples(output_prefix + '_samples_meta.json', key='all') 
edge_df= (edge_gen(output_prefix,
                     samples,
                     sample_selected = '', # select a subset of samples, e.g. "0,1,3"
...
lclusters = run_wlpa(edge_df, maxIter=5)
